...
%fileOut= fullfile(pathOut,[scriptName,char(extractAfter(fileName,'groundTruth'))]);  
fileOut= fullfile(pathOut,char(extractAfter(fileName,'groundTruth')));  
